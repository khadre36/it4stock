...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Détails de la commande reçue - <?php echo $po_code ?></h4>
    </div>
    <div class="card-body" id="print_out">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label text-info">De Code Commande d'achat</label>
                ...
                <?php if(isset($bo_id)): ?>
                <div class="col-md-6">
                    <label class="control-label text-info">De Code Commande en attente</label>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=receiving/manage_receiving&id='.(isset($id) ? $id : '') ?>">Modifier</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=receiving' ?>">Retour à la liste</a>
    </div>
</div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Détails de la commande reçue - Vue avant impression")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Commande reçue</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
