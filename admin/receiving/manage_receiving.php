...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title"><?php echo !isset($id) ? "Formulaire liste de retour ".$po_code : 'Mettre à jour la commande reçue' ?></h4>
    </div>
    <div class="card-body">
        <form action="" id="receive-form">
            ...
            <div class="container-fluid">
                <div class="row">
                    <?php if(!isset($bo_id)): ?>
                    <div class="col-md-6">
                        <label class="control-label text-info">Commande</label>
                        <input type="text" class="form-control form-control-sm rounded-0" value="<?php echo isset($po_code) ? $po_code : '' ?>" readonly>
                    </div>
                    <?php else: ?>
                        <div class="col-md-6">
                        <label class="control-label text-info">Commande en cours</label>
                ...
                <table class="table table-striped table-bordered" id="list">
                    ...
                    <thead>
                        <tr class="text-light bg-navy">
                            ...
                            <th class="text-center py-1 px-2">Prix</th>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=purchase_order' ?>">Supprimer</a>
    </div>
</div>
<script>
    $(function(){
