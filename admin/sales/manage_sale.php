...
<div class="card card-outline card-primary">
  ...
  <div class="card-body">
    <form action="" id="sale-form">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <label class="control-label text-info">Code de vente</label>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" name="client" class="form-control form-control-sm rounded-0" value="<?php echo isset($client) ? $client : 'Client' ?>">
            </div>
          </div>
        </div>
        <hr>
  ...
  <div class="card-footer py-1 text-center">
    <button class="btn btn-flat btn-primary" type="submit" form="sale-form">Enregistrer</button>
    <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=sale' ?>">Annuler</a>
  </div>
</div>
