...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Details de vente - <?php echo $sales_code ?></h4>
    </div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Registre des ventes - Vue avant impression")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Registre des ventes</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
