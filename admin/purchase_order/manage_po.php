  ...
  <div class="card-body">
    <form action="" id="po-form">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <label class="control-label text-info">Code Commande</label>
    ...
    $('#supplier_id').change(function() {
      ...
      if (!!items[supplier_id]) {
        ...
        list_item.then(function() {
          $('#item_id').select2({
            placeholder: "Veuillez sélectionner un article",
            width: 'resolve',
          })
        })
      } else {
        list_item.then(function() {
          $('#item_id').select2({
            placeholder: "Aucun article n'a encore été répertorié",
            width: 'resolve',
          })
        })
      }
