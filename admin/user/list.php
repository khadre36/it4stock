...
<div class="card card-outline card-primary">
  <div class="card-header">
    <h3 class="card-title">Liste d'utilisateurs du système</h3>
    <div class="card-tools">
      <a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> Ajouter</a>
    </div>
  </div>
  <div class="card-body">
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <p class="m-0"><?php echo ($row['type'] == 1) ? "Administrateur" : "Personnel" ?></p>
                </td>
                <td align="center">
                  <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
                    Action
                    <span class="sr-only">Basculer vers le bas</span>
                  </button>
...
<script>
  $(document).ready(function() {
    $('.delete_data').click(function() {
      _conf("Êtes-vous sûr de vouloir supprimer cet utilisateur de façon permanente ?", "delete_user", [$(this).attr('data-id')])
    })
