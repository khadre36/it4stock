...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Détails de la commande - <?php echo $bo_code ?></h4>
    </div>
            ...
            <table class="table table-striped table-bordered" id="list">
                ...
                <thead>
                    <tr class="text-light bg-navy">
                        ...
                        <th class="text-center py-1 px-2">Articles</th>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Détails de la commande en cours - Vue avant impression")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Commande en cours</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
