      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
            <li><a href="#" class="dropdown-item">Quelques actions </a></li>
            <li><a href="#" class="dropdown-item">Autre action</a></li>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Appelez-moi quand vous le pouvez...</p>
          ...
          <a href="#" class="dropdown-item">
            ...
            <div class="media">
              ...
              <div class="media-body">
                ...
                <p class="text-sm">Le sujet est traité ici</p>
                <p class="text-sm text-muted"><i class="far fa-clock mr-1"></i> 4 Il y a quelques heures</p>
              </div>
            </div>
            <!-- Message End -->
          </a>
