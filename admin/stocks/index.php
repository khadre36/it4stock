...
<script>
  $(document).ready(function() {
    $('.delete_data').click(function() {
      _conf("Êtes-vous sûr de vouloir supprimer définitivement ces commandes reçues ?", "supprimer_réception", [$(this).attr('data-id')])
    })
    $('.view_details').click(function() {
      uni_modal("Détails de la réception", "receiving/view_receiving.php?id=" + $(this).attr('data-id'), 'mid-large')
    })
