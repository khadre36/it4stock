...
<div class="card card-outline card-primary">
    <div class="card-header">
        <h4 class="card-title">Fiche de retour - <?php echo $return_code ?></h4>
    </div>
    ...
    <div class="card-footer py-1 text-center">
        ...
        <a class="btn btn-flat btn-primary" href="<?php echo base_url.'/admin?page=return/manage_return&id='.(isset($id) ? $id : '') ?>">Modifier</a>
        <a class="btn btn-flat btn-dark" href="<?php echo base_url.'/admin?page=return' ?>">Retour à la liste</a>
    </div>
</div>
    ...
    $(function(){
        $('#print').click(function(){
            ...
            var _head = $('head').clone()
                _head.find('title').text("Enregistrement retourné - Vue avant impression")
            ...
            _el.append('<div class="d-flex justify-content-center">'+
                      ...
                      '<h4 class="text-center">Enregistrement retourné</h4>'+
                      '</div>'+
                      '<div class="col-1 text-right">'+
                      '</div>'+
                      '</div><hr/>')
