...
<div class="card card-outline card-primary">
  <div class="card-header">
    <h4 class="card-title"><?php echo isset($id) ? "Détails du retour - " . $return_code : 'Créer une nouvelle fiche de retour' ?></h4>
  </div>
  <div class="card-body">
    <form action="" id="return-form">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-6">
            <label class="control-label text-info">Code de retour</label>
        ...
        <hr>
        <fieldset>
          <legend class="text-info">Formulaire de l'article</legend>
          <div class="row justify-content-center align-items-end">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label for="qty" class="control-label">Qtté</label>
        ...
        <table class="table table-striped table-bordered" id="list">
          ...
          <thead>
            <tr class="text-light bg-navy">
              ...
              <th class="text-center py-1 px-2">Qtté</th>
  ...
  <div class="card-footer py-1 text-center">
    <button class="btn btn-flat btn-primary" type="submit" form="return-form">Enregistrer</button>
    <a class="btn btn-flat btn-dark" href="<?php echo base_url . '/admin?page=return' ?>">Annuler</a>
  </div>
</div>
...
<script>
  ...
  $(function() {
    $('.select2').select2({
      placeholder: "Veuillez choisir ici",
      width: 'resolve',
    })
    $('#item_id').select2({
      placeholder: "Veuillez choisir l'article",
      width: 'resolve',
    })
    ...
    $('#supplier_id').change(function() {
      ...
      if (!!items[supplier_id]) {
        ...
        list_item.then(function() {
          $('#item_id').select2({
            placeholder: "Veuillez choisir un article ici",
            width: 'resolve',
          })
        })
      } else {
        list_item.then(function() {
          $('#item_id').select2({
            placeholder: "Pas encore d'articles listés",
            width: 'resolve',
          })
        })
      }
    ...
    $('#add_to_list').click(function() {
      ...
      if (item == '' || qty == '' || unit == '') {
        alert_toast('Les champs de texte  du formulaire sont obligatoires.', 'Attention');
        return false;
      }
