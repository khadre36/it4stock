...
class Users extends DBConnection
{
  ...
  public function save_users()
  {
    ...
    if (empty($id)) {
      ...
      if ($qry) {
        ...
        $this->settings->set_flashdata('success', 'Utilisateur enregistrer avec succes.');
        $resp['status'] = 1;
      } else {
        $resp['status'] = 2;
      }
      ...
      if ($qry) {
        $this->settings->set_flashdata('success', 'Utilisateur modifie avec succes.');
  ...
  public function delete_users()
  {
    ...
    if ($qry) {
      ...
      $this->settings->set_flashdata('success', 'Utilisateur supprimé avec succès.');
